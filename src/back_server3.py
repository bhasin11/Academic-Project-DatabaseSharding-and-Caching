...
from back_database3 import Example3
from back_database3 import db
from back_database3 import createDatabase
...
def createEntry():
    ...
    try:
        ...
        newUser = Example3(ox['id'], ox['name'], ox['email'], ox['category'],ox['description'],
...
def withExpenseID(expense_id):
    ox2 = Example3.query.filter_by(id=expense_id).first_or_404()
...
if __name__ == '__main__':
    ...
    r_server.lrem("PORTS", "127.0.0.1:5003", 0)
    r_server.rpush("PORTS", "127.0.0.1:5003")
